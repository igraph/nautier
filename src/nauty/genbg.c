...
void
static writeny(FILE *f, graph *g, int n1, int n2) 
...
void
static writeg6x(FILE *f, graph *g, int n1, int n2)
...
void
static writes6x(FILE *f, graph *g, int n1, int n2)
/* write graph g (n1+n2 vertices) to file f in graph6 format */
{
    writes6(f,g,1,n1+n2);
}
...
void
static writenauty(FILE *f, graph *g, int n1, int n2)
