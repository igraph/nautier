...
**************************************************************************
    ...
    Changes:  Nov 18, 1991 : added -d switch
              ...
              Jan  8, 1992 : make static writeny() not static
              ...
              Feb 25, 1992 : changed static writenauty() to use fwrite()
...
void
static writeny(FILE *f, graph *g, int n)
...
void
static writes6x(FILE *f, graph *g, int n)
...
void
static writenauty(FILE *f, graph *g, int n)
